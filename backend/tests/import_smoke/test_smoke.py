...
EXPECTATIONS = [
    ...
    (
        "lc01_simple_dict_tool.py",
        "langchain",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
    ...
    (
        "lc04_helper_function_used.py",
        "langchain",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc05_module_constants_used.py",
        "langchain",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc06_nested_import_in_tool.py",
        "langchain",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc07_basetool_dict_return.py",
        "langchain",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc08_basetool_str_return.py",
        "langchain",
        {"confidence": "medium", "draft_ready": True, "min_tools": 1},
    ),
    # ── LangChain edge cases ──
    (
        "lc09_args_schema_pydantic.py",
        "langchain",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc10_env_var_usage.py",
        "langchain",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc11_try_except_optional_import.py",
        "langchain",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc12_unknown_import_unused.py",
        "langchain",
        {"confidence": "medium", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc13_missing_type_hints.py",
        "langchain",
        {"confidence": "medium", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc14_single_unresolved_symbol.py",
        "langchain",
        {"confidence": "medium", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc15_helper_class_used.py",
        "langchain",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "lc16_lambda_usage_in_helper.py",
        "langchain",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    # ── CrewAI ──
    (
        "cr01_simple_named_tool.py",
        "crewai",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
    ...
    (
        "cr03_tool_with_defaults.py",
        "crewai",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "cr04_tool_with_helper_function.py",
        "crewai",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "cr05_tool_with_constants.py",
        "crewai",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "cr06_requests_dependency.py",
        "crewai",
        {
            "confidence": "high",
            "draft_ready": True,
    ...
    (
        "cr07_file_io_tool.py",
        "crewai",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    (
        "cr08_env_var_tool.py",
        "crewai",
        {"confidence": "high", "draft_ready": True, "min_tools": 1},
    ),
    # ── Blockers ──
    (
        "blk01_langchain_async_tool.py",
        "langchain",
        {"confidence": "low", "draft_ready": False, "min_tools": 1},
    ),
    (
        "blk02_crewai_async_tool.py",
        "crewai",
        {"confidence": "low", "draft_ready": False, "min_tools": 1},
    ),
    (
        "blk03_basetool_self_usage.py",
        "langchain",
        {"confidence": "low", "draft_ready": False, "min_tools": 1},
    ),
    (
        "blk04_relative_import_langchain.py",
        "langchain",
        {"confidence": "low", "draft_ready": False, "min_tools": 1},
    ),
    (
        "blk05_structured_tool_from_function.py",
        "langchain",
        {"confidence": "low", "draft_ready": False},
    ),
    (
        "blk06_unknown_import_active.py",
        "langchain",
        {"confidence": "low", "draft_ready": False, "min_tools": 1},
    ),
    ...
    (
        "rw01_structured_tool_dynamic.py",
        "langchain",
        {"confidence": "low", "draft_ready": False},
    ),
    # rw02: BaseTool with List[str] return + BaseTool with str return (2 tools)
    (
        "rw02_basetool_list_return.py",
        "langchain",
        {"confidence": "medium", "draft_ready": True, "min_tools": 2},
    ),
    # rw03: BaseTool with args_schema, clean _run body, requests dep
    (
        "rw03_basetool_args_schema.py",
        "langchain",
        {
            "confidence": "high",
            "draft_ready": True,
...
def test_smoke_fixture(filename: str, platform: str, expected: dict):
    ...
    if "manifest_version" in expected:
        assert (
            resp.manifest_json.get("manifest_version") == expected["manifest_version"]
        )
    ...
    if expected["draft_ready"]:
        ...
        assert "langchain" not in tool_py, (
